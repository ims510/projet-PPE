...
Pour obtenir les tableaux contenant l'ensemble de nos données, on a utilisé les scripts bash suivants pour les 3 langues. Ensuite, on a mis les resultats de ces scripts dans un template html, pour que tout s'affiche sous la forme d'une page web. 
